    ...
    if (navigator.geolocation) {
        ...
        navigator.geolocation.getCurrentPosition(function (position) {
            ...
            $.getJSON(url + latitude + ',' + longitude, function (data) {
                ...
                if (tempCel <= 10) {
                    $('.other-jumbo').css({
                        'backgroundImage': 'url(https://char502.github.io/pics/wintry/nature-3279071_960_720.jpg)'
                    });
                    $('#weatherStatement').html("<h1>It's a bit chilly today<hr></h1>");
                } else if (tempCel > 10 && tempCel < 18) {
                    $('.other-jumbo').css({
                        'backgroundImage': 'url(https://char502.github.io/pics/mild/sunlight-2547619_960_720.jpg)',
                        'color': 'white'
                    });
                    ...
                    $('.other-jumbo').css({
                        'backgroundImage': 'url(https://char502.github.io/pics/hot/desert-790640_960_720.jpg)'
                    });
